	...
	void textureBuild::useTextures_PerMaterial(shading::shader& shaderID, int max_Texture_mat)
	{
		...
		if (difusseNr != specularNr)
		{
			...
			if (specularNr == 1 && difusseNr == 1)
			{
				...
				{
					for (int i = 0; i < static_cast<int>(texturesData.size()); i++) ///Cambiarlo en algun futuro para el tama�o o cantidad de materiales en el shader
					{
...
namespace vertexCreationData
{
	...
	//A�ADIDO DE NORMALES EN EL SEGUNDO 
